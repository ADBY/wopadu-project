...
class CookController extends \yii\web\Controller
{
	...
	public function actionOrders(){
		...
		if($kitchen)
		{
			...
			{			
				$order = Yii::$app->db->createCommand("SELECT id,order_number, table_location, add_note, allergies, status, n_datetime FROM orders WHERE id = ".$pol['order_id']." and payment_status = 1")->queryOne();
...
exit;*/
	...
	{
		Yii::$app->mycomponent->sendOrderReadyPush(207,263,1);
