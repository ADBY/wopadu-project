        ...
        if ($model->load(Yii::$app->request->post()))
		{
			if($model->variety_name != "") {
				...
				foreach($language as $lang) {
					...
					$translated_array = Yii::$app->mycomponent->bingTraslateAPI($model->variety_name, "en", $lang['language_code']);
			...
			if($gen_error == "" && $model->save())
			{
				...
				Yii::$app->mycomponent->translateItemNotif(['type' => 4, 'item_id' => $model->id]);
