...
class TranslaterUserController extends Controller
{
	...
	public function actionUpdateNotif()
	{
		...
		echo '<a href="#" class="btn btn-default dropdown-toggle info-number" data-toggle="dropdown">
                    <i class="fa fa-bell-o"></i>';
        if($count_notif > 0) { echo '<span class="badge">'.$count_notif.'</span>'; }
        echo '</a>';
		echo '<div class="dropdown-menu dropdown-menu-head pull-right">
                    <h5 class="title">Notifications</h5>
                    <ul class="dropdown-list normal-list">';
		if($count_notif > 0)
		{
			if($store_count > 0) { echo '<li class="new"><a href="'.Yii::$app->urlManager->createUrl('translater-user/translate-item?type=1').'"><span class="label label-danger"><i class="fa fa-bolt"></i></span><span class="name">'.$store_count.' Stores had been added.</span></a></li>';
}
			if($cat_count > 0) { echo '<li class="new"><a href="'.Yii::$app->urlManager->createUrl('translater-user/translate-item?type=2').'"><span class="label label-danger"><i class="fa fa-bolt"></i></span><span class="name">'.$cat_count.' Categories had been added.</span></a></li>';
}
			if($prod_count > 0) { echo '<li class="new"><a href="'.Yii::$app->urlManager->createUrl('translater-user/translate-item?type=3').'"><span class="label label-danger"><i class="fa fa-bolt"></i></span><span class="name">'.$prod_count.' Products had been added.</span></a></li>';
}
			if($variety_count > 0) { echo '<li class="new"><a href="'.Yii::$app->urlManager->createUrl('translater-user/translate-item?type=4').'"><span class="label label-danger"><i class="fa fa-bolt"></i></span><span class="name">'.$variety_count.' Products varieties had been added.</span></a></li>';
}
			if($op_main_count > 0) { echo '<li class="new"><a href="'.Yii::$app->urlManager->createUrl('translater-user/translate-item?type=5').'"><span class="label label-danger"><i class="fa fa-bolt"></i></span><span class="name">'.$op_main_count.' Product options had been added.</span></a></li>';
}
			if($op_sub_count > 0) { echo '<li class="new"><a href="'.Yii::$app->urlManager->createUrl('translater-user/translate-item?type=6').'"><span class="label label-danger"><i class="fa fa-bolt"></i></span><span class="name">'.$op_sub_count.' Sub options had been added.</span></a></li>';
}
		} else {
			echo '<li class="new"><a href="#">No new notifications</a></li>';
		}
		echo '</ul>
		</div>';
	}
