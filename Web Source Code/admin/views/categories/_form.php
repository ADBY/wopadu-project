...
<?php } ?>
    ...
    <?php if(!$model->isNewRecord && $model->images != "" && file_exists('images/categories/'.$model->images)) { ?>
    <div class="form-group field-categories-images">
	    <div class="col-md-offset-3 col-md-7">
        	<img src="../images/categories/<?= $model->images ?>" title="Category Image" alt="Category Image" style="width:200px"/>
	...
	<?php /*?><div class="form-group field-categories-image_1" style="margin-bottom:30px;">
    	<label class="col-md-3 col-sm-3 control-label" for="categories-image_1">Image</label>
        <div class="col-md-7">
        	<input type="file" id="categories-image_1" name="Categories[image_1]" style="margin-top:5px">
        </div>
    </div><?php */?>
