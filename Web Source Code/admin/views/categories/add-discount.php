...
$this->title = 'Add Discount: '.$item['name'];
...
$this->params['breadcrumbs'][] = 'Add Discount';
?>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="post" action="" onSubmit="return check_form()">
                        <div class="form-group">
                            <label class="col-sm-3 control-label col-md-3" for="inputSuccess">Select Type</label>
                            <div class="col-md-6">
                                <label class="checkbox-inline" style="padding-left:0">
                                    <input type="radio" name="promotion_main_type" id="promotion_main_type_1" value="1" onChange="set_promotion_main_type(this)" <?php if($discount['promotion_main_type'] == 1) { echo "checked"; } ?>>
                                    <div style="float:right; margin-left:10px;">Date Range</div>
                                </label>
                                <label class="checkbox-inline">
                                    <input type="radio" name="promotion_main_type" id="promotion_main_type_2" value="2" onChange="set_promotion_main_type(this)" <?php if($discount['promotion_main_type'] == 2) { echo "checked"; } ?>>
                                    <div style="float:right; margin-left:10px;">Days</div>
                                </label>
                            </div>
                        </div>
                        <div id="pro_main_type_1" <?php if($discount['promotion_main_type'] == 2) { echo 'style="display:none"'; } ?>>
                            <div class="form-group">
                        ...
                        <div id="pro_main_type_2" <?php if($discount['promotion_main_type'] == 1) { echo 'style="display:none"'; } ?>>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-3 col-md-6">
                                ...
                                <button type="submit" class="btn btn-success" name="submit">Add Promotion</button>
                                <br /><br />
