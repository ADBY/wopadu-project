        	...
        	<section class="panel panel-peter-river">
				<?php /*?><div class="panel-heading">
                	...
                	<span class="pull-right">
                        ...
                        <a class="btn btn-danger btn-xs" href="<?= Yii::$app->urlManager->createUrl(['categories/delete-menu/', 'id' => $_GET['s']]) ?>"><i class="fa fa-eye"> Delete</i></a>
                    </span>
                </div><?php */?>
                <div class="panel-body pull-right">
                	<div class="pull-right">
                        <a class="btn btn-success" type="button" href="<?= Yii::$app->urlManager->createUrl(['categories/create/', 's' => $_GET['s'], 'c' => 0]) ?>"><i class="fa fa-plus"></i> Add Category</a>
                        <a class="btn btn-info" type="button" href="<?= Yii::$app->urlManager->createUrl(['item-option/index/', 's' => $_GET['s']]) ?>"><i class="fa fa-eye"></i> View Product Options</a>
                        <a class="btn btn-info" type="button" href="<?= Yii::$app->urlManager->createUrl(['csv-upload/csv-upload/', 's' => $_GET['s']]) ?>" style="background-color: #775447; border-color: #8D6E63;"><i class="fa fa-file"></i> Upload Menu from file</a>
                        <a class="btn btn-danger" type="button" onClick="return confirm('Are you sure you want to delete the comlete menu ?');" href="<?= Yii::$app->urlManager->createUrl(['categories/delete-menu/', 'id' => $_GET['s']]) ?>"><i class="fa fa-trash-o"></i> Delete Menu</a>
                    </div>
                </div>
            </section>
        </div>
