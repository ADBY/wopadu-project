                ...
                <div class="col-md-12">
                    ...
                    <div>
                    	<div class="col-md-12" style="padding-left:0">
                        	<div class="col-md-6" style="padding-left:0"><h4><strong><?php echo $order['username']; ?></strong></h4></div>
                            <div class="col-md-6 text-right" style="padding-right:0"><h4><strong>Order No. <?= $order['order_number'] ?></strong></h4></div>
                        </div>
                        ...
                        <?php /*?><h4><strong>Order No. <?= $order['order_number'] ?></strong></h4><?php */?>
