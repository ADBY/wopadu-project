...
<?php if(!$model->isNewRecord) { ?>
                ...
                <div class="tab-pane" id="about-3">
					...
					<?php
						echo '<h4><strong>List Name</strong></h4>';
                        foreach($language as $lang) {
                            echo $form->field($model, 'option_name_'.$lang['language_lc'])->textInput(['maxlength' => true])->label("in ".$lang['language_lc']);
                        }
                    ?>
	...
	<div class="form-group">
		<label class="col-md-3 col-sm-3 control-label"><?php echo ' in '.$lang['language_lc']; ?></label>
		<div class="col-md-7">
			<input type="text" class="form-control" name="sub_name_<?php echo $lang['language_lc']; ?>[]" maxlength="256" value="<?= $options_data['sub_name_'.$lang['language_lc']][$i] ?>">
		</div>
	</div>
			<?php 				}
							}
