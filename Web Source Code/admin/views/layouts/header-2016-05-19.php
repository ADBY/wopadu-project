        ...
        <ul class="notification-menu">
            ...
            <li>
                <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    ...
                    <?php $session = Yii::$app->session; if($session['login_role'] == 1) { echo "Admin"; } else if($session['login_role'] == 2) { echo $session['account_name']; } else if($session['login_role'] == 3) { echo $session['emp_name']; } ?>
