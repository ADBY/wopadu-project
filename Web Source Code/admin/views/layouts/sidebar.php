...
<div class="left-side sticky-left-side">
    ...
    <div class="left-side-inner">
        ...
        <ul class="nav nav-pills nav-stacked custom-nav">
            ...
            <li <?php if( ($session['login_role'] == 1 || $session['login_role'] == 11) && $controller_name == "accounts" && ($action_name == "index" || $action_name == "create" || $action_name == "update" || $action_name == "view")) { echo 'class="active"'; } ?>>
                <a href="<?= Yii::$app->urlManager->createUrl('accounts/index') ?>">
                    <i class="fa fa-bars"></i>
                    <?php if(($session['login_role'] == 1 || $session['login_role'] == 11)) { ?>
                    <span> Accounts</span>
                    <?php } else { ?>
            ...
            <li <?php if(($controller_name == "categories" || $controller_name == "items" || $controller_name == "item-option" || $controller_name == "csv-upload") && ($action_name == "index" || $action_name == "list" || $action_name == "create" || $action_name == "update" || $action_name == "view" || $action_name == "csv-upload")) { echo 'class="active"'; } ?>>
            ...
            <li <?php if($controller_name == "admin-sub" && ($action_name == "view" || $action_name == "update")) { echo 'class="active"'; } ?>>
                <a href="<?= Yii::$app->urlManager->createUrl('admin-sub/view?id='.$session['a_user_id']) ?>">
                    <i class="fa fa-user"></i>
                    <span> Profile</span>
                </a>
            </li>
            ...
            <li <?php if($controller_name == "admin-sub" && ($action_name == "index" || $action_name == "view" || $action_name == "create")) { echo 'class="active"'; } ?>>
                <a href="<?= Yii::$app->urlManager->createUrl('admin-sub/index') ?>">
