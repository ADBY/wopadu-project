            ...
            <section class="panel panel-primary">
                <header class="panel-heading">
                    ...
                    <span class="pull-right">
                        ...
                        <?php /*?><?= Html::a(
									...
									['order-details/print', 'id'=> $model->id],
									[
										'title' => 'Print',
						...
						?><?php */?>
                        <a class="btn btn-xs btn-warning" href="#" title="Print" onClick="loadOtherPage();"><span class="fa fa-print"></span> Print</a>
                ...
                <div class="panel-body">
                    ...
                    <table class="table_cust_1" style="width:100%">
                        ...
                        <tr>
                            <td><strong>Order in Processing Datetime</strong></td>
                        ...
                        <tr>
                            <td><strong><?php /*?>Complete/Cancel<?php */?><?php if($model->status == 4){ echo "Completed"; } else if($model->status == 5) { echo "Cancel"; } ?> Datetime</strong></td>
...
function loadOtherPage() {
    ...
    $("<iframe>")                             // create a new iframe element
        ...
        .attr("src", "<?= Yii::$app->urlManager->createUrl(['order-details/print', 'id' => $model->id]) ?>") // point the iframe to the page you want to print
