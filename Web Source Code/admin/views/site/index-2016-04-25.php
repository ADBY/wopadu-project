                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-inline" role="form" style="margin-bottom:20px;">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="">Select Type</label>
                                        <select class="form-control" name="criteria_5_<?= $key ?>" id="criteria_5_<?= $key ?>" onChange="sel_crt_5(this.value, <?= $key ?>)">
                                            <option value="1">All</option>
                                            <option value="2">One Category</option>
                                            <option value="3">One Product</option>
                                        </select>
                                    </div>
                                    <div class="form-group" id="cat_display_<?= $key ?>">
                                        
                                    </div>
                                    <div class="form-group" id="item_display_<?= $key ?>">
...
function sel_crt_5(a, b)
{
	if(a == 1)
	{
		//$("#cat_display_c_"+b).css("display", "none");
		//$("#cat_display_p_"+b).css("display", "none");
		$("#cat_display_"+b).css("display", "none");
		$("#item_display_"+b).css("display", "none");
	}
	else if(a == 2)
	{
		//$("#cat_display_p_"+b).css("display", "none");
		...
		$("#cat_display_"+b).css("display", "inline-block");
		getCatList(a, b);
	}
	else if(a == 3)
	{
...
function sel_crt_6(a, b)
{
	...
	$.ajax({
		...
		success: function(data){
			$("#item_display_"+b).css("display", "inline-block");
			$("#item_display_"+b).html(data);
		},
		error: function(){
			$("#item_display_"+b).css("display", "inline-block");
			$("#item_display_"+b).html('<span style="color:#C0392B">Something went wrong, Please try again.</span>');
		}		
	});
}
...
function getCatList(a, b)
{
	...
	$.ajax({
		...
		cache: false,
		success: function(data){
			$("#cat_display_"+b).html(data);
		},
		error: function(){
			$("#cat_display_"+b).html('<span style="color:#C0392B">Something went wrong, Please try again.</span>');
		}		
	});
}
