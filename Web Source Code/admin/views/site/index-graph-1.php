                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="chartJS">
                                    <canvas id="bar-chart-js-<?= $key ?>" height="250" width="800" ></canvas>
                                </div>
                                <?php } else { ?>
                                No orders
                                <?php } ?>
...
(function(){
    ...
    function redraw(animation){
        ...
        var barChartData<?= $key ?> = {
            //labels : ["January","February","March","April","May","June","July"],
			labels : [<?php $label = ""; foreach($store_bar_array[$key]['bar_month_array'] as $mm)	{ $label .= '"'.date("m-Y", strtotime($mm)).'",'; } echo rtrim($label, ","); ?>],
            datasets : [
                {
                    fillColor : "#2a323f",
                    strokeColor : "#2a323f",
                    //data : [65,59,90,81,56,55,40]
					data : [<?php $label = ""; foreach($store_bar_array[$key]['bar_total_array'] as $mm)	{ $label .= $mm.','; } echo rtrim($label, ","); ?>]
                },
            ]

        }

        var myLine = new Chart(document.getElementById("bar-chart-js-<?= $key ?>").getContext("2d")).Bar(barChartData<?= $key ?>);
		<?php } } ?>
    }
