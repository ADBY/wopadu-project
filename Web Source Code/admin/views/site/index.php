            ...
            <div class="col-md-12">
                ...
                <div class="row state-overview" style="color:#607D8B">
                    <div class="col-md-3 col-xs-6 col-sm-3">
                        <a href="<?= Yii::$app->urlManager->createUrl('accounts/index') ?>" style="text-decoration:none; color:#607D8B">
                        <div class="panel">
                            <div class="symbol">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-3">
                        <a href="<?= Yii::$app->urlManager->createUrl('users/index') ?>" style="text-decoration:none; color:#607D8B">
                        <div class="panel">
                            <div class="symbol">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-3">
                        <a href="<?= Yii::$app->urlManager->createUrl('app-rating/index') ?>" style="text-decoration:none; color:#607D8B">
                        <div class="panel">
                            <div class="symbol">
                ...
                <div class="row state-overview" style="color:#607D8B">
                    <div class="col-md-6 col-xs-6 col-sm-3">
                        <div class="panel">
                            ...
                            <div class="state-value">
                                <div class="value"><?= $totalPending = Yii::$app->db->createCommand("SELECT COUNT(id) FROM `translater_item` WHERE action = 0")->queryScalar(); ?></div>
                                <div class="title">Pending Corrections</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xs-6 col-sm-3">
