 ...
 *      URL: http://localhost:8080/wopado/ws/account-verify.php?ws=1&user_id=1&send_email=1
 * 
 *		Verify Account
 * 		URL: http://localhost:8080/wopado/ws/account-verify.php?ws=1&user_id=1&verif_code=WIFX2Y
*/
				...
				else
				{
					...
					else
					{
						...
						if(mysqli_query($link, $sql))
						{
							...
							$subject 	= "Wopado - Email is verified";
							...
							print_r('OK');	//Account is verified successfully
							exit;
						}
						else
						{
