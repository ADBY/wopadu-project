...
*	URL:
http://localhost:8080/wopado/ws/fb-g-connect.php?first_name=Shirish&last_name=Makwana&email=shirishm.makwana@gmail.com&connect=fb
*
*/
			...
			else
			{
				...
				{				
					...
					$message 	= '
						...
						<head>
						<meta charset="utf-8">
						<title>Account created | Wopado</title>
						</head>
						...
						<table dir="ltr">
							<tbody>
								...
								<tr>
									<td style="padding:0;font-family:\'Segoe UI Light\',\'Segoe UI\',\'Helvetica Neue Medium\',Arial,sans-serif;font-size:41px;color:#18633A">Your password for wopado account has been generated.</td>
								</tr>
								<tr>
									<td style="padding:0;padding-top:25px;font-family:\'Segoe UI\',Tahoma,Verdana,Arial,sans-serif;font-size:14px;color:#2a2a2a">Please use your email at WOPADO account to login <a dir="ltr" style="color:#2672ec;text-decoration:none" href="mailto:'.$email.'" target="_blank">'.$email.'</a>.</td>
								</tr>
								<tr>
