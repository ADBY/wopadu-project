...
/*
*	Share Wopado Application
* 	URL: http://localhost:8080/wopado/ws/share-app.php?user_id=1&email=shirishm.makwana@gmail.com&desc=Hellloooooooooo
*/
	...
	else
	{
		...
		{		
			...
			{						
				...
				$subject 	= "Wopado - Your friend has invited you";
				...
				<div>
					...
					if($e_check)
					{
						...
						if(mysqli_num_rows($e_check) == 0)
						{
							$message .=
								'<tr>
									<td style="padding:0;padding-top:25px;font-family:\'Segoe UI\',Tahoma,Verdana,Arial,sans-serif;font-size:14px;color:#2a2a2a">Download Wopado application <span style="color:#ff9000;text-decoration:none" href="#" target="_blank">here</span>.</td>
								</tr>
								<tr>
									<td>
