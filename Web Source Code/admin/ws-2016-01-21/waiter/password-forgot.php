...
* 	URL: 
*	Step - 1: http://localhost:8080/wopado/ws/waiter/password-forgot.php?step=1&email=shirishm.makwana@gmail.com
*	Step - 2: http://localhost:8080/wopado/ws/waiter/password-forgot.php?step=2&email=shirishm.makwana@gmail.com&verif_code=123456&n_password=shirish&r_password=shirish
*/
	...
	else
	{
		...
		else
		{
			...
			else
			{
				...
				$subject 	= "Wopado - Forgot Password";
				...
				$message 	= '
					...
					<tbody>
						...
						<tr>
							<td style="padding:0;padding-top:25px;font-family:\'Segoe UI\',Tahoma,Verdana,Arial,sans-serif;font-size:14px;color:#2a2a2a">Please use this code to change your password at Wopado account <a dir="ltr" style="color:#2672ec;text-decoration:none" href="mailto:'.$email.'" target="_blank">'.$email.'</a>.</td>
						</tr>
						<tr>
