...
*
*	My Rating:
*	URL: http://localhost:8080/wopadu/ws/app-rating.php?action=view&user_id=1
*
*	Add/Update Rating
* 	URL: http://localhost:8080/wopadu/ws/app-rating.php?action=add_update&user_id=1&rating=3&review=awesome...
*
*	All Ratings of Application:
*	URL: http://localhost:8080/wopadu/ws/app-rating.php?action=all&page=1
*/
