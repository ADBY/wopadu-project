...
*	Forgot Pin
* 	URL: 
*	http://localhost:8080/wopadu/ws/forgot-pin.php?email=shirishm.makwana@gmail.com
*/
	...
	else
	{
		...
		else
		{
			...
			else
			{
				...
				$subject 	= "Wopadu - Forgot Security Pin";
				...
				$message 	= '
					...
					<tbody>
						...
						<tr>
							<td style="padding:0;font-family:\'Segoe UI Light\',\'Segoe UI\',\'Helvetica Neue Medium\',Arial,sans-serif;font-size:41px;color:#CE1764">Forgot Security Pin</td>
						</tr>
						<tr>
							<td style="padding:0;padding-top:25px;font-family:\'Segoe UI\',Tahoma,Verdana,Arial,sans-serif;font-size:14px;color:#2a2a2a">Please use this pin for your Wopadu account <a dir="ltr" style="color:#2672ec;text-decoration:none" href="mailto:'.$user_email.'" target="_blank">'.$user_email.'</a>.</td>
						</tr>
						<tr>
