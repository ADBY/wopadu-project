...
* 	URL: http://localhost:8080/wopadu/ws/login.php?ws=1&email=shirishm.makwana@gmail.com&password=shirish
*/
			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						if($row['expiry_date_month'] == "")
						{
							$row['expiry_date_month'] = NULL;
						}
						if($row['expiry_date_year'] == "")
						{
							$row['expiry_date_year'] = NULL;
						}
