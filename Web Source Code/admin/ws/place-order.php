...
/*
*	Place Order
* 	URL: http://localhost:8080/wopadu/ws/place-order.php?ws=1&user_id=1&store_id=1&items=JSON&table_location=2&grand_total=25&order_note=nops&allergies=no allergies
*
*/
...
if(!isset($_REQUEST['user_id']) || !isset($_REQUEST['store_id']) || !isset($_REQUEST['table_location']) || !isset($_REQUEST['grand_total']) || !isset($_REQUEST['order_note']) || !isset($_REQUEST['allergies']))
{
...
exit;*/
		...
		$res_order = mysqli_query($link, "INSERT INTO `orders`(`user_id`, `store_id`, `order_number`, `invoice_number`, `order_type`, `table_location`, `total_amount`, `add_note`, `allergies`, `status`, `n_datetime`) VALUES ('$user_id', '$store_id', '$order_number', '$invoice_number', '$order_type', '$table_location', '$grand_total', '$order_note', '$allergies', '$status', '$n_datetime')");
