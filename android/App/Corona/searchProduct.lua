...
local count
local waterRequest
local VariableTable = { background, header, restaurantName, restaurantAdd, homeBtn, waterBtn, searchBtn, searchProductScrollView,
    ...
    if ( phase == "will" ) then
		...
		-- Access Google over SSL:
       	...
       	if(#search_productData > 0) then
        	...
        	noItem = display.newText( tostring(GBCLanguageCabinet.getText("noItemLabel",_LanguageKey)), _W/2, _H/2, _FontArr[26], _H/35 )
