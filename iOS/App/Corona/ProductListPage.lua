...
local count
local VariableTable = { background, header, restaurantName, restaurantAdd, homeBtn, searchBtn, menuScrollView,
		noCategory, CategoryTitleBg, CategoryTitle, backBg, backBtn }
		
local beginX,endX,proList_OverRect,waterRequest		
...
local function createNavigation()
   ...
   if(_HotelAddress:len() > 60) then
    ...
    NavigationVariableTable_pList.UserEmail = display.newText(UserMailText,-_W/1.28 + _W/15.42,_H/2.57,_FontArr[6],_H/45 )
    ...
    NavigationVariableTable_pList.ProfileEditBg.anchorX = 1
    ...
    NavigationVariableTable_pList.CartLabel = display.newText(GBCLanguageCabinet.getText("viewCartLabel",_LanguageKey),-_W/1.28 + _W/7.2,NavigationVariableTable_pList.Rect1.y,_FontArr[6],_H/36.76)
    ...
    NavigationVariableTable_pList.OrderLabel = display.newText(GBCLanguageCabinet.getText("orderHistoryLabel", _LanguageKey),-_W/1.28 + _W/7.2,NavigationVariableTable_pList.Rect2.y,_FontArr[6],_H/36.76)
    ...
    NavigationVariableTable_pList.FeedBackLabel = display.newText(GBCLanguageCabinet.getText("faqLabel", _LanguageKey),-_W/1.28 + _W/7.2,NavigationVariableTable_pList.Rect3.y,_FontArr[6],_H/36.76)
    ...
    NavigationVariableTable_pList.SettingLabel = display.newText(GBCLanguageCabinet.getText("settingLabel", _LanguageKey),-_W/1.28 + _W/7.2,NavigationVariableTable_pList.Rect4.y,_FontArr[6],_H/36.76)
    ...
    NavigationVariableTable_pList.RestaurantLabel = display.newText(GBCLanguageCabinet.getText("restaurantLabel", _LanguageKey),-_W/1.28 + _W/7.2,NavigationVariableTable_pList.Rect6.y,_FontArr[6],_H/36.76)
    ...
    NavigationVariableTable_pList.LogOutLabel = display.newText(GBCLanguageCabinet.getText("logoutLabel", _LanguageKey),-_W/1.28 + _W/7.2,NavigationVariableTable_pList.Rect5.y,_FontArr[6],_H/36.76)
	...
	if( #ProductIDArr > 0 ) then
		...
		timer.performWithDelay( 250, function()
        	...
        	for i = 1, #ProductIDArr do
				...
				VariableTable.menuScrollView:setScrollHeight( (((#defaultPhoto/2) * defaultPhoto[1].height) + ((#defaultPhoto/2)* _H/96) + _W/2 ))
        	
        		if( i == #ProductIDArr ) then
...
local function onStartDisplay()
	local k = 1
        ...
        if(#productData > 0) then
        	...
        	noItem = display.newText( GBCLanguageCabinet.getText("13Alert",_LanguageKey), _W/2,_H/2,_FontArr[26],_H/35 )
...
function scene:show( event )
    ...
    if ( phase == "will" ) then
		...
		Language.x = _W/36
		Language.y = VariableTable.header2.y
		Language.anchorX = 0
		Language:addEventListener("tap",handleButtonEvent)
		displayGroup:insert( Language )
    ...
    elseif ( phase == "did" ) then
        ...
        timer.performWithDelay( 250, onShowFunc,1 )
...
function scene:hide( event )
    ...
    if ( phase == "will" ) then
        ...
        if(VariableTable.backBtn) then
        	display.remove(VariableTable.backBtn)
        	VariableTable.backBtn = nil
        end
