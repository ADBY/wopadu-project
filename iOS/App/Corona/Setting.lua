...
function scene:create( event )
    ...
    -- Example: add display objects to "sceneGroup", add touch listeners, etc.
        ...
        heading = display.newText( GBCLanguageCabinet.getText("settingLabel",_LanguageKey), header.x, header.y, _FontArr[30], _H/36.76 )
...
function scene:show( event )
    ...
    if ( phase == "will" ) then
        ...
        rectBg = { }
		title = { }
		titleName = {GBCLanguageCabinet.getText("ChangePasswordLabel",_LanguageKey),GBCLanguageCabinet.getText("termsCondiLabel",_LanguageKey),GBCLanguageCabinet.getText("AboutUsLabel",_LanguageKey),GBCLanguageCabinet.getText("RateWopaduLabel",_LanguageKey),GBCLanguageCabinet.getText("shareLabel",_LanguageKey)}
