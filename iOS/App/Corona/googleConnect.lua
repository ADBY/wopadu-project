...
local options = {}
options.client_id = "700466645255-vgk57cv320svsm7rg21j2c7nh1k16sop.apps.googleusercontent.com"
options.client_secret = "oQBKeJjVOcbasRcHdY6Uw9nz"
...
function authenticateUser()
	...
	native.showWebPopup( 0, _H/16.69, _W, _H, authUrl)
	...
	closeBtn.y = _H/64
	closeBtn:toFront()
	closeBtn:addEventListener("tap",handleButtonEvent)
