...
local function createNavigation()
    ...
    NavigationVariableTable.CartLabel = display.newText(tostring(GBCLanguageCabinet.getText("viewCartLabel",_LanguageKey)),-_W/1.28 + _W/7.2,NavigationVariableTable.Rect1.y,_FontArr[6],_H/36.76)
    ...
    NavigationVariableTable.OrderLabel = display.newText(tostring(GBCLanguageCabinet.getText("orderHistoryLabel", _LanguageKey)),-_W/1.28 + _W/7.2,NavigationVariableTable.Rect2.y,_FontArr[6],_H/36.76)
    ...
    NavigationVariableTable.FeedBackLabel = display.newText(tostring(GBCLanguageCabinet.getText("faqLabel", _LanguageKey)),-_W/1.28 + _W/7.2,NavigationVariableTable.Rect3.y,_FontArr[6],_H/36.76)
    ...
    NavigationVariableTable.SettingLabel = display.newText(tostring(GBCLanguageCabinet.getText("settingLabel", _LanguageKey)),-_W/1.28 + _W/7.2,NavigationVariableTable.Rect4.y,_FontArr[6],_H/36.76)
    ...
    NavigationVariableTable.RestaurantLabel = display.newText(tostring(GBCLanguageCabinet.getText("restaurantLabel", _LanguageKey)),-_W/1.28 + _W/7.2,NavigationVariableTable.Rect6.y,_FontArr[6],_H/36.76)
    ...
    NavigationVariableTable.LogOutLabel = display.newText(tostring(GBCLanguageCabinet.getText("logoutLabel", _LanguageKey)),-_W/1.28 + _W/7.2,NavigationVariableTable.Rect5.y,_FontArr[6],_H/36.76)
...
function scene:show( event )
    ...
    elseif ( phase == "did" ) then
        ...
        timer.performWithDelay( 250, onShowDisplay, 1 )
    end
end
